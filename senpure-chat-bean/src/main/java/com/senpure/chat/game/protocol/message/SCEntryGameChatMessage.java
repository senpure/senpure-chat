 ...
 */
public class SCEntryGameChatMessage extends  Message {

    public static final int MESSAGE_ID = 4000201;
    private int roomId;
    private User user;
    /**
     * 写入字节缓存
    ...
    public SCEntryGameChatMessage setRoomId(int roomId) {
        this.roomId=roomId;
        return this;
    }
    public  User getUser() {
    ...
    public SCEntryGameChatMessage setUser(User user) {
        this.user=user;
        return this;
    }
    ...
    public String toString() {
        return "SCEntryGameChatMessage[4000201]{"
                +"roomId=" + roomId
                +",user=" + user
                + "}";
   }
    ...
    public String toString(String indent) {
        ...
        sb.append("SCEntryGameChatMessage").append("[4000201]").append("{");
        sb.append("\n");
