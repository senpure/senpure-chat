 ...
 */
public class SCLoadUserMessage extends  Message {
    ...
    public SCLoadUserMessage setUser(User user) {
        this.user=user;
        return this;
    }
    ...
    public String toString() {
        return "SCLoadUserMessage[1000104]{"
                +"user=" + user
                + "}";
   }
    ...
    public String toString(String indent) {
        ...
        sb.append("SCLoadUserMessage").append("[1000104]").append("{");
        sb.append("\n");
