 ...
 */
public class CSFreeChatMessage extends  Message {

    public static final int MESSAGE_ID = 3000100;
    private long userId;
    private String type;
    ...
    public CSFreeChatMessage setUserId(long userId) {
        this.userId=userId;
        return this;
    }
    ...
    public CSFreeChatMessage setType(String type) {
        this.type=type;
        return this;
    }
    ...
    public CSFreeChatMessage setContent(String content) {
    ...
    public String toString() {
        return "CSFreeChatMessage[3000100]{"
                +"userId=" + userId
                +",type=" + type
                +",content=" + content
                + "}";
    ...
    public String toString(String indent) {
        ...
        sb.append("CSFreeChatMessage").append("[3000100]").append("{");
        sb.append("\n");
